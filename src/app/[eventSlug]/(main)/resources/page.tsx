          ...
          <div className="glass rounded-[32px] p-8 border-white/[0.06] space-y-8">
            ...
            {[
              ...
              },
              {
                ...
                steps: [
                  ...
                  "Your project is scored across 7 criteria (Innovation 25%, Technical Execution 20%, Functional Completeness 20%, Problem–Solution Fit 15%, UX 10%, Demo 5%, Ambition 5%)",
            ...
            <div className="rounded-2xl border border-white/[0.05] overflow-hidden">
              ...
              {[
                ...
                { label: "Problem–Solution Fit", weight: "15%", note: "Solving a real problem convincingly" },
                { label: "UX & Design", weight: "10%", note: "Visual polish and usability" },
