...
export default async function AdminDashboard({ params }: AdminDashboardProps) {
  ...
  const portalSlug = activeSlug || eventSlug;
  const activeEvent = allEvents.find((ev) => ev.slug === portalSlug);
  const portalPath = activeEvent?.is_hackathon ? `/${portalSlug}/hackathon` : `/${portalSlug}/agenda`;
