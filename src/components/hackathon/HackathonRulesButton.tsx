  ...
  return (
    <>
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center gap-2 rounded-2xl border border-white/15 bg-white/10 font-bold uppercase tracking-[0.16em] text-white transition-all hover:border-red-400/40 hover:bg-red-500/15 hover:text-red-100",
