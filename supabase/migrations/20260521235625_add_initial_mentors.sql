...
BEGIN
  ...
  VALUES
    (v_event_id, 'Oguzhan Dogru', 'University of Alberta', 'Judge & Mentor', 'in_person', 10, 'University of Alberta mentor and judge supporting teams on technical architecture, product strategy, and pitching. Oguzhan brings an academic and builder-focused perspective to help teams sharpen both implementation and presentation.', NULL),
