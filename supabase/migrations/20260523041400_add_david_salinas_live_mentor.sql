...
BEGIN
  ...
  SET
    ...
    in_person_location = 'Live on site at SAIT',
    in_person_schedule = 'Available for in-person mentorship during the hackathon',
    is_mentor = true,
    is_judge = true,
    updated_at = NOW()
  ...
  ELSE
    ...
    VALUES (
      ...
      'in_person',
      'Live on site at SAIT',
      'Available for in-person mentorship during the hackathon',
      150,
